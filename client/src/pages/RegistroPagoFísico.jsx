        ...
        <>
            ...
            <div className={style.rectangle}>
                <Stack direction='row' spacing={2} sx={{marginTop: '10px'}}>
                    <TextField id='EventoDeportivo' label='Evento deportivo al que pertenece el pago' variant="outlined" fullWidth/>
                    <TextField id='EquipoPago' label='Equipo que pago' variant="outlined" fullWidth/>
                </Stack>
                <Stack direction='row' spacing={2} sx={{marginTop: '10px'}}>
                ...
                <Stack direction='row' spacing={2} sx={{marginTop: '10px'}}>
                    <TextField id='NombrePago' label='Concepto' variant="outlined" sx={{width: '49%'}}/>
                </Stack>
                <TextField
                id="notas"
